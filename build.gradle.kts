...
dependencies {
    intellijPlatform {
        ...
        bundledPlugins("com.intellij.java", "org.jetbrains.kotlin", "com.intellij.database")
        plugins("net.fallingangel.jimmer-dto:$jimmerDtoVersion")
...
intellijPlatform {
    pluginConfiguration {
        id = "net.fallingangel.jimmer-craft"
        name = "JimmerCraft"
